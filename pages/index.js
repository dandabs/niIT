    ...
    <div className="relative bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          name="t"
          id="terms"
          className="focus:ring-indigo-500 focus:border-indigo-500 pl-4 pr-7 sm:text-sm rounded-l-none rounded-r-none border-gray-300 rounded-m h-full w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md"
